...
{
    /// <inheritdoc />
    public partial class ayasesemsd : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GameConfigSnapshot = table.Column<string>(type: "text", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AvatarImageName = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AuthLocals", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AuthLocals_Players_PlayerId",
                        column: x => x.PlayerId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AuthOAuths", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AuthOAuths_Players_PlayerId",
                        column: x => x.PlayerId,
                        principalTable: "Players",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TopicName = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: true),
                    Modifier = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AuthLocals_PlayerId",
                table: "AuthLocals",
                column: "PlayerId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_AuthOAuths_PlayerId",
                table: "AuthOAuths",
                column: "PlayerId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GameParticipants_GameSessionId",

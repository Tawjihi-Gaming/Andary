  ...
  const confirmLogout = async () => {
   ...
   return (
    <div className="relative">
        <nav dir="rtl" className="relative z-10 px-3 sm:px-6 py-3">
        <div className="max-w-7xl mx-auto flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
          ...
          <div className="flex items-center gap-2 sm:gap-3 flex-wrap">
            ...
            <button
              ...
              className="app-soft-btn border border-transparent hover:bg-game-purple/20 hover:text-game-purple hover:border-game-purple/30 font-semibold px-4 sm:px-5 py-2 sm:py-2.5 rounded-2xl transition-all duration-300 cursor-pointer"
            >
              👥 {t('friends.navButton')}
            </button>
            ...
            <button
              ...
              className="app-soft-btn border border-transparent hover:bg-red-500/20 hover:text-red-400 hover:border-red-500/30 font-semibold px-4 sm:px-5 py-2 sm:py-2.5 rounded-2xl transition-all duration-300 cursor-pointer"
            >
              {t('lobby.logout')}
            </button>
          </div>

...
function LoginPage() {
  return (
    <>
      <div className="min-h-screen bg-gradient-to-br from-[#1E3A8A] via-[#2563EB] to-[#0EA5E9] flex items-center justify-center p-4 relative overflow-hidden">
      {/* Background */}
        <div className="absolute inset-0 opacity-65">
          <div className="absolute top-10 left-10 w-24 h-24 border-4 border-white rounded-full animate-pulse animate-bounce"></div>
          ...
          <div className="absolute bottom-40 right-10 w-8 h-8 bg-white rounded-full animate-pulse animate-bounce"></div>
        </div>
